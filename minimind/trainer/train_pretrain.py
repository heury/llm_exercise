...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind 사전학습")
    parser.add_argument("--save_dir", type=str, default="../checkouts", help="모델 저장 디렉터리")
    parser.add_argument('--save_weight', default='pretrain', type=str, help="저장할 가중치 파일의 접두사")
    ...
    parser.add_argument("--data_path", type=str, default="../datasets/pretrain_english_wikitext2_mini.jsonl", help="사전학습 데이터 경로")
    parser.add_argument('--from_weight', default='none', type=str, help="어떤 가중치에서 학습을 시작할지 지정합니다. none이면 처음부터 학습합니다")
