...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind 전체 SFT")
    parser.add_argument("--save_dir", type=str, default="../checkouts", help="모델 저장 디렉터리")
    parser.add_argument('--save_weight', default='full_sft', type=str, help="저장할 가중치 파일의 접두사")
    parser.add_argument("--epochs", type=int, default=2, help="학습 에폭 수")
    parser.add_argument("--batch_size", type=int, default=16, help="배치 크기")
    parser.add_argument("--learning_rate", type=float, default=1e-5, help="초기 학습률")
    ...
    parser.add_argument('--max_seq_len', default=768, type=int, help="학습 시 최대 절단 길이(중국어 기준 1토큰은 약 1.5~1.7자)")
    ...
    parser.add_argument('--from_weight', default='pretrain', type=str, help="어떤 가중치에서 학습을 시작할지 지정합니다. none이면 기반 가중치 없이 학습합니다")
